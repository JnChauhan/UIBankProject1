...
namespace BankingUI1Proj.Data.Migrations
{
    ...
    [Migration("20191111012234_customerValidation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingUI1Proj.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("BankingUI1Proj.Models.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankingUI1Proj.Models.TDCAdditionInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AccountNum1");

                    b.ToTable("TDCAdditionInfos");
                });

            modelBuilder.Entity("BankingUI1Proj.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankingUI1Proj.Models.TDCAdditionInfo", b =>
                {
                    b.HasOne("BankingUI1Proj.Models.Account", "Account")
                        .WithMany("TDCAdditional")
                        .HasForeignKey("AccountNum1");
                });
